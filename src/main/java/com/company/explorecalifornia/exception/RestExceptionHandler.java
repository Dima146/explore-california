...
/**
 * The class {@code RestExceptionHandler} contains methods for handling exceptions
 * which occur during application execution.
 *
 */
...
public final class RestExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleInvalidPaginationException(InvalidPaginationException exc) {
        LOGGER.info("Invalid pagination: {}", exc.getMessage());
        ErrorResponse errorResponse = new ErrorResponse();
    ...
    public ResponseEntity<ErrorResponse> handleMissingRequestParameterException(HttpMessageNotReadableException exc) {
        ...
        ErrorResponse errorResponse = new ErrorResponse();
        errorResponse.setStatus(HttpStatus.BAD_REQUEST.toString());
        errorResponse.setMessage("Required request body with parameters is missing");
        errorResponse.setTimeStamp(LocalDateTime.now());
        return new ResponseEntity<>(errorResponse, HttpStatus.BAD_REQUEST);
    }
    ...
    public ResponseEntity<ErrorResponse> handleMethodArgumentTypeMismatchException(
        ...
        ErrorResponse errorResponse = new ErrorResponse();
        errorResponse.setStatus(HttpStatus.BAD_REQUEST.toString());
        errorResponse.setMessage(exc.getName() + " must be of type " +
    ...
    public ResponseEntity<ErrorResponse> handleMissingServletRequestParameterException(
        ...
        LOGGER.info("Request is missing a parameter: {}", exc.getParameterName());
        ErrorResponse errorResponse = new ErrorResponse();
        errorResponse.setStatus(HttpStatus.BAD_REQUEST.toString());
        errorResponse.setMessage(exc.getParameterName() + " must be Easy, Medium, Difficult or Varies");
        errorResponse.setTimeStamp(LocalDateTime.now());
        return new ResponseEntity<>(errorResponse, HttpStatus.BAD_REQUEST);
    }
